	...
	const products = [
		{
			...
			title: 'Plates',
			description:
				'Plates is a unitary computing platform of hybrid systems designed to establish healthy relationships with your devices.',
			logo: '/plates.png',
			tech: [
		...
		},
		{
			...
			tech: [
				{ label: 'rust', class: 't-rust' },
				{ label: 'servo', class: 't-servo' },
				{ label: 'zircon', class: 't-zircon' },
		...
		},
		{
			...
			title: 'Standpoint',
			description:
				'Standpoint is the ultimate opinion-based social media platform and tool for creating tierlists, voting on polls and sharing standpoints.',
			logo: '/standpoint.png',
			tech: [
			...
			links: [
				...
				{
					label: 'github',
					href: 'https://github.com/atechnology-company/standpoint',
					external: true
				}
			]
		},
		{
			...
			title: 'Infrastruct',
			description:
				'Infrastruct is a belief-agnostic logic-filtered unitarian jurisprudence system for all major religions.',
			...
			links: [
				{
					label: 'github',
					href: 'https://github.com/atechnology-company/infrastruct',
					external: true
				},
				{
					label: 'whitepaper',
					href: 'https://undivisible.notion.site/infrastruct-22f5f9801be48068aa1bdb1899ad9ed4',
					external: true
				},
				{
					label: 'site',
		...
		},
		{
			...
			title: 'Vuno',
			description:
				'Vuno is the utilitarian keyboard focused minimal text editor for everyday life. Edit code, documents, or just take notes, with markdown support, code highlighting and an AI copilot.',
			logo: '/vuno.png',
			tech: [
				{ label: 'tauri', class: 't-tauri' },
				{ label: 'svelte', class: 't-svelte' },
		...
		},
		{
			...
			title: 'Berd',
			description:
				'Berd is the first chat app on iOS to use the Apple Intelligence API, with Visual Intelligence and Private Cloud Compute.',
			logo: '/berd.png',
			tech: [
				{ label: 'swift', class: 't-swift' },
				{ label: 'c++', class: 't-cpp' },
		...
		},
		{
			...
			title: 'Akh',
			description:
				'Akh is the ultimate muslim companion, aiming to centralise all Islamic software on one platform.',
			logo: '/akh.png',
			tech: [
				{ label: 'tauri', class: 't-tauri' },
				{ label: 'svelte', class: 't-svelte' },
...
{#if $showIndicator}
	<div class="fixed top-0 right-0 w-full z-[250] pointer-events-none">
		<div
			class="ml-auto w-fit flex gap-6 pr-[clamp(2rem,4vw,6rem)] text-sm select-none pointer-events-auto"
			style="align-items: center; height: calc(var(--logo-center, 48px)); padding-top: 5rem;"
		>
			{#each products as p, i}
				<button
					class="relative transition-colors duration-150 font-semibold outline-none {$current === i
						? 'text-white'
						: 'text-white/50'}"
